...
void Scene5c::Init()
{
	...
	meshList[GEO_SPHERE] = MeshBuilder::GenerateSphere2("sphere", Color(1, 0.5, 0), 90, 360, 2.0F);
	meshList[GEO_SPHERE2] = MeshBuilder::GenerateSphere2("sphere2", Color(1, 0, 0), 45, 45, 0.5F);
	meshList[GEO_SPHERE3] = MeshBuilder::GenerateSphere2("sphere3", Color(0, 1, 0), 45, 45, 1.0F);
	meshList[GEO_SPHERE4] = MeshBuilder::GenerateSphere2("sphere4", Color(0, 0, 1), 45, 45, 1.0F);
...
void Scene5c::Render()
{
	...
	modelStack.Rotate(rotate_value, 0, 1, 0);
	MVP = projectionStack.Top() * viewStack.Top() * modelStack.Top();
	glUniformMatrix4fv(m_parameters[U_MVP], 1, GL_FALSE, &MVP.a[0]);
	...
	modelStack.Rotate(rotate_value2, 0, 1, 0);
	...
	modelStack.Rotate(rotate_value3, 0, 1, 0);
	...
	modelStack.Rotate(rotate_value4, 0, 1, 0);
