...
void Assignment::Init()
{
	...
	//meshList[GEO_CUBE] = MeshBuilder::GenerateCube("cube", Color(1, 0, 0), 1.0f);
	...
	meshList[GEO_CIRCLE]->material.kDiffuse.Set(1.0f, 1.0f, 1.0f);
	...
	meshList[GEO_HEAD_CYLINDER] = MeshBuilder::GenerateCylinderHead("head", Color(0.5098039215686274, 0.7372549019607844, 0.21568627450980393), Color(0.9411764705882353, 0.803921568627451, 0.7137254901960784), Color(0.9411764705882353, 0.803921568627451, 0.7137254901960784), 10, 2.0f, 5);
...
void Assignment::Render()
{
	...
	RenderMesh(meshList[GEO_HEAD_CYLINDER], true);
	modelStack.PopMatrix();

	modelStack.PushMatrix();
	modelStack.Translate(2.5, 7, 0);
	modelStack.Rotate(-90, 0, 0, 1);
	RenderMesh(meshList[GEO_HEMISPHERE_SIDES], true);
	modelStack.PopMatrix();
