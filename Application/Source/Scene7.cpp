...
void Scene7::Init()
{
	...
	meshList[GEO_LIGHTBALL2] = MeshBuilder::GenerateSphere2("lightball22", Color(1, 1, 0), 45, 45, 0.2);
	...
	meshList[GEO_QUAD] = MeshBuilder::GenerateQuad("quad", 1, 1, Color(0.0f, 0.f, 0.5f));
...
void Scene7::Render()
{
	...
	Position lightPosition_cameraspace1 = viewStack.Top() *
		light[1].position;
	glUniform3fv(m_parameters[U_LIGHT1_POSITION], 1,
		&lightPosition_cameraspace1.x);
...
void Scene7::RenderMesh(Mesh* mesh, bool enableLight)
{
